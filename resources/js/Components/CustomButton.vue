...
const presetClasses = {
    primary: "bg-primary text-white hover:bg-hover hover:text-white",
    secondary: "bg-background text-primary hover:bg-hover hover:text-white",
    accent: "bg-accent text-black hover:bg-hover hover:text-white",
    neutral:
