    ...
    <main class="min-h-screen bg-background pb-8" role="main">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <p class="text-lg text-black mb-8 text-center">
                Testing all button presets and sizes on different background
                colors
            </p>
            ...
            >
                ...
                <!-- Test each preset -->
                <div v-for="preset in presets" :key="preset" class="mb-8">
                ...
                >
                    ...
                    >
                        <div
                            :class="[
                                bg.class,
                                'w-16 h-16 rounded-lg border-2 border-gray-400',
                            ]"
                        ></div>
                        <div>
